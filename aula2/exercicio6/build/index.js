...
// Criando clientes
const cliente1 = new Clientes_1.Cliente("João", 35);
const cliente2 = new Clientes_1.Cliente("Maria", 28);
// Criando contas
const contaPJ1 = new Contas_1.ContaPJ(1234, "Empresa ABC", 5000, "1234567890");
const contaPF1 = new Contas_1.ContaPF(5678, "João Silva", 2000, "01234567890");
const contaPF2 = new Contas_1.ContaPF(9876, "Maria Souza", 3000, "09876543210");
